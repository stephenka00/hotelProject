...
export async function getAllBookings() {
    try{
        ...
        throw new Error(`Error fetching booking data: ${error.message}`)
    }
}
...
export async function registerUser(registration) {
    try{
        ...
        if(error.response && error.result.data){
            throw new Error(error.response.data)
        }else{
            throw new Error(`User registration unsuccessfully: ${error.message}`)
        }
    }
}
